...
export const ExternalDataSchemasPartialUpdateBody = /* @__PURE__ */ zod.object({
    ...
    sync_type: zod.string().nullish().describe('Sync strategy: incremental, full_refresh, append, or cdc.'),
    incremental_field: zod.string().nullish().describe('Column name used to track sync progress.'),
    incremental_field_type: zod.string().nullish().describe('Data type of the incremental field.'),
    sync_frequency: zod.string().nullish().describe('How often to sync: 30min, 1hour, 6hour, 12hour, or 24hour.'),
