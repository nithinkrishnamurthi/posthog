...
class TestSsoBypass(APIBaseTest):
    ...
    def _create_user(self, email: str, organization: Organization, *, bypass_sso: bool = False) -> User:
    ...
    def test_password_login_rejected_for_enforced_domain_without_bypass(self) -> None:
        self._create_user("regular@bypasscorp.example", self.organization)
    ...
    def test_password_login_allowed_with_bypass_in_enforcing_org(self) -> None:
        self._create_user("guest@bypasscorp.example", self.organization, bypass_sso=True)
    ...
    def test_password_login_rejected_for_bypass_in_different_org(self) -> None:
        ...
        user = self._create_user("outsider@bypasscorp.example", other_org, bypass_sso=True)
    ...
    def test_password_login_works_on_unenforced_domain_regardless_of_bypass(self) -> None:
        ...
        self._create_user("normal@other.example", self.organization)
