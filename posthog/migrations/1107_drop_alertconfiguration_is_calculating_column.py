...
class Migration(migrations.Migration):
    ...
    The field was removed from Django state in migration 1106. This migration
    drops the physical column. Safe to deploy once 1106 has been rolled out
    everywhere — any old code still reading the column would have failed at
    migration 1106 time.
    """

    dependencies = [("posthog", "1106_remove_alertconfiguration_is_calculating")]
